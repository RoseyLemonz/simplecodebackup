...
void loop() 
{
  setleds(0x80); delay(lightdelay); 
  setleds(0x40); delay(lightdelay);
  setleds(0x20); delay(lightdelay);
  setleds(0x10); delay(lightdelay);
  setleds(0x08); delay(lightdelay);
  setleds(0x04); delay(lightdelay);
  setleds(0x02); delay(lightdelay);
  setleds(0x01); delay(lightdelay);
}
